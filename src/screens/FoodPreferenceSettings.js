...
import { parseMonthYear } from '../common/time';
...
import { Button, ButtonGroup, CheckBox, FormLabel, ListItem } from 'react-native-elements';
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      settingsList: [
        ...
        {title: 'Blah', action: () => console.log('boooooop')}
      ]
    };
  ...
  render() {
    ...
    return (
      <SafeAreaView styles={globalStyles.container}>
        ...
        <FlatList
          data={this.state.settingsList.slice()}
